...
@class JDPatchFMDatabase, JDPatchFMStatement, NSMutableDictionary, NSString;

@interface JDPatchFMResultSet : NSObject
{
    JDPatchFMDatabase *_parentDB;
    JDPatchFMStatement *_statement;
    NSString *_query;
...
@property(retain) JDPatchFMStatement *statement; // @synthesize statement=_statement;
