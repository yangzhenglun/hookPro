...
#import "JDPAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class JDPAFHTTPRequestSerializer<JDPAFURLRequestSerialization>, JDPAFHTTPResponseSerializer<JDPAFURLResponseSerialization>, NSURL;

@interface JDPAFHTTPSessionManager : JDPAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    JDPAFHTTPRequestSerializer<JDPAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) JDPAFHTTPRequestSerializer<JDPAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) JDPAFHTTPResponseSerializer<JDPAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
