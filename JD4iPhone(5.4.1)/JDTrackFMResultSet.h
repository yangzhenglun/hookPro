...
@class JDTrackFMDatabase, JDTrackFMStatement, NSMutableDictionary, NSString;

@interface JDTrackFMResultSet : NSObject
{
    JDTrackFMDatabase *_parentDB;
    JDTrackFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) JDTrackFMStatement *statement; // @synthesize statement=_statement;
