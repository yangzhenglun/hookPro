...
@class JDMTAFMDatabase, JDMTAFMStatement, NSMutableDictionary, NSString;

@interface JDMTAFMResultSet : NSObject
{
    JDMTAFMDatabase *_parentDB;
    JDMTAFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) JDMTAFMStatement *statement; // @synthesize statement=_statement;
