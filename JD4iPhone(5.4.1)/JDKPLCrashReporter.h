...
@class JDKPLCrashMachExceptionPortSet, JDKPLCrashMachExceptionServer, JDKPLCrashReporterConfig, NSString;

@interface JDKPLCrashReporter : NSObject
{
    JDKPLCrashReporterConfig *_config;
    _Bool _enabled;
    JDKPLCrashMachExceptionServer *_machServer;
    JDKPLCrashMachExceptionPortSet *_previousMachPorts;
