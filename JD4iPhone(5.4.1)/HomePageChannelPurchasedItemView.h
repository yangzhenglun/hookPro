...
@class HomePageChannelProductMarkView, HomePageChannelProductOutOfStockLabel, HomePageChannelProductTagsView, JDImageView, NSString, UIButton, UILabel, UITapGestureRecognizer;

@interface HomePageChannelPurchasedItemView : UIView <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
    ...
    UILabel *_priceLabel;
    UIButton *_viewSimilarItemsButton;
...
@property(retain, nonatomic) UIButton *viewSimilarItemsButton; // @synthesize viewSimilarItemsButton=_viewSimilarItemsButton;
