...
@interface HomePageChannelBrandActivitiesView : HomePageChannelReusableView <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
    NSMutableArray *_brandActivityViews;
}

+ (struct CGSize)calculateSizeWithData:(id)arg1 constrainedToSize:(struct CGSize)arg2;
@property(retain, nonatomic) NSMutableArray *brandActivityViews; // @synthesize brandActivityViews=_brandActivityViews;
- (void).cxx_destruct;
