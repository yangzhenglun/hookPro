...
@interface HomePageChannelContainerCell : UITableViewCell <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
...
@property(retain, nonatomic) NSMutableDictionary *reusableViews; // @synthesize reusableViews=_reusableViews;
- (void).cxx_destruct;
