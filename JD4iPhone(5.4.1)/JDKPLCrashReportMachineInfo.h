...
@class JDKPLCrashReportProcessorInfo, NSString;

@interface JDKPLCrashReportMachineInfo : NSObject
{
    NSString *_modelName;
    JDKPLCrashReportProcessorInfo *_processorInfo;
...
@property(readonly, nonatomic) JDKPLCrashReportProcessorInfo *processorInfo; // @synthesize processorInfo=_processorInfo;
