...
@class NSData, NSDictionary, NSError, SimplePing;

@protocol SimplePingDelegate <NSObject>

@optional
- (void)simplePing:(SimplePing *)arg1 didReceiveUnexpectedPacket:(NSData *)arg2;
- (void)simplePing:(SimplePing *)arg1 didReceivePingResponsePacket:(NSData *)arg2 sequenceNumber:(unsigned short)arg3 ipData:(NSDictionary *)arg4;
