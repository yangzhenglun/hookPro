...
@interface LCLogMessage : NSObject <NSCopying>
{
    NSString *_message;
...
- (id)initWithMessage:(id)arg1 level:(unsigned long long)arg2 flag:(unsigned long long)arg3 context:(long long)arg4 file:(id)arg5 logName:(id)arg6 function:(id)arg7 line:(unsigned long long)arg8 tag:(id)arg9 options:(long long)arg10 timestamp:(id)arg11;
