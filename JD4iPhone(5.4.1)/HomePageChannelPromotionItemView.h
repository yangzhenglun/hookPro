...
@class HomePageChannelProductMarkView, HomePageChannelProductOutOfStockLabel, HomePageChannelPromotionItemViewLayoutManager, JDImageView, NSString, UIButton, UILabel, UITapGestureRecognizer;

@interface HomePageChannelPromotionItemView : UIView <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
    ...
    HomePageChannelPromotionItemViewLayoutManager *_layoutManager;
}

+ (struct CGSize)calculateSizeWithData:(id)arg1 constrainedToSize:(struct CGSize)arg2;
@property(retain, nonatomic) HomePageChannelPromotionItemViewLayoutManager *layoutManager; // @synthesize layoutManager=_layoutManager;
