...
@class JDKPLCrashReportApplicationInfo, JDKPLCrashReportExceptionInfo, JDKPLCrashReportMachExceptionInfo, JDKPLCrashReportMachineInfo, JDKPLCrashReportProcessInfo, JDKPLCrashReportSignalInfo, JDKPLCrashReportSystemInfo, NSArray;

@interface JDKPLCrashReport : NSObject
{
    struct _PLCrashReportDecoder *_decoder;
    JDKPLCrashReportSystemInfo *_systemInfo;
    JDKPLCrashReportMachineInfo *_machineInfo;
    JDKPLCrashReportApplicationInfo *_applicationInfo;
    JDKPLCrashReportProcessInfo *_processInfo;
    JDKPLCrashReportSignalInfo *_signalInfo;
    JDKPLCrashReportMachExceptionInfo *_machExceptionInfo;
    NSArray *_threads;
    NSArray *_images;
    JDKPLCrashReportExceptionInfo *_exceptionInfo;
    struct __CFUUID *_uuid;
}

@property(readonly, nonatomic) struct __CFUUID *uuidRef; // @synthesize uuidRef=_uuid;
@property(readonly, nonatomic) JDKPLCrashReportExceptionInfo *exceptionInfo; // @synthesize exceptionInfo=_exceptionInfo;
...
@property(readonly, nonatomic) JDKPLCrashReportMachExceptionInfo *machExceptionInfo; // @synthesize machExceptionInfo=_machExceptionInfo;
@property(readonly, nonatomic) JDKPLCrashReportSignalInfo *signalInfo; // @synthesize signalInfo=_signalInfo;
@property(readonly, nonatomic) JDKPLCrashReportProcessInfo *processInfo; // @synthesize processInfo=_processInfo;
@property(readonly, nonatomic) JDKPLCrashReportApplicationInfo *applicationInfo; // @synthesize applicationInfo=_applicationInfo;
@property(readonly, nonatomic) JDKPLCrashReportMachineInfo *machineInfo; // @synthesize machineInfo=_machineInfo;
@property(readonly, nonatomic) JDKPLCrashReportSystemInfo *systemInfo; // @synthesize systemInfo=_systemInfo;
