...
@interface JDPLoggerNode : NSObject
{
    id <JDPLogger> _logger;
    unsigned long long _level;
    NSObject<OS_dispatch_queue> *_loggerQueue;
}

+ (id)jdp_nodeWithLogger:(id)arg1 loggerQueue:(id)arg2 level:(unsigned long long)arg3;
...
@property(readonly, nonatomic) id <JDPLogger> logger; // @synthesize logger=_logger;
- (void).cxx_destruct;
- (void)dealloc;
