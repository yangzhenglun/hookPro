...
@class JDPAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface JDPAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    JDPAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) JDPAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
