...
@class JDPFMDatabase, JDPFMStatement, NSMutableDictionary, NSString;

@interface JDPFMResultSet : NSObject
{
    JDPFMDatabase *_parentDB;
    JDPFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) JDPFMStatement *statement; // @synthesize statement=_statement;
