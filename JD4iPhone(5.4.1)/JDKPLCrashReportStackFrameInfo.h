...
@class JDKPLCrashReportSymbolInfo;

@interface JDKPLCrashReportStackFrameInfo : NSObject
{
    unsigned long long _instructionPointer;
    JDKPLCrashReportSymbolInfo *_symbolInfo;
}

@property(readonly, nonatomic) JDKPLCrashReportSymbolInfo *symbolInfo; // @synthesize symbolInfo=_symbolInfo;
