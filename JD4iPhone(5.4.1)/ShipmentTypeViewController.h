...
@class ChooseShipmentTypeView, DeliveryTopView, JDOrderPayAndShipmentEditModel, JDOrderPayAndShipmentParameterModel, JDStoreNetwork, NOINotifyView, NSArray, NSString, UIButton, UITableView, pickShipmentModel;

@interface ShipmentTypeViewController : OrderSubViewController <OrderSubViewControllerDelegate, PickSiteViewControllerDelegate, ChooseDeliveryServiceDelegate, PayAndShipLayoutDelegate>
{
