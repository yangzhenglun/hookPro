...
@class JDPAFHTTPSessionManager, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>;

@interface JDPAFImageDownloader : NSObject
{
    id <JDPAFImageRequestCache> _imageCache;
...
@property(retain, nonatomic) JDPAFHTTPSessionManager *sessionManager; // @synthesize sessionManager=_sessionManager;
@property(retain, nonatomic) id <JDPAFImageRequestCache> imageCache; // @synthesize imageCache=_imageCache;
- (void).cxx_destruct;
