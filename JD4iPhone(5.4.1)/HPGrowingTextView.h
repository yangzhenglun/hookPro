...
@property(nonatomic) _Bool animateHeightChange; // @synthesize animateHeightChange;
@property(nonatomic) int minHeight; // @synthesize minHeight;
@property(nonatomic) int maxHeight; // @synthesize maxHeight;
@property(nonatomic) NSObject<HPGrowingTextViewDelegate> *delegate; // @synthesize delegate;
