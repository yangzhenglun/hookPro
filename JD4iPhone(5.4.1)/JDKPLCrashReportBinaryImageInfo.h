...
@interface JDKPLCrashReportBinaryImageInfo : NSObject
{
...
@property(readonly, nonatomic) JDKPLCrashReportProcessorInfo *codeType; // @synthesize codeType=_processorInfo;
- (void)dealloc;
