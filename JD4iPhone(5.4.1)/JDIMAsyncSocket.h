...
@class JDIMAsyncReadPacket, JDIMAsyncWritePacket, NSArray, NSMutableArray, NSMutableData, NSTimer;

@interface JDIMAsyncSocket : NSObject
{
    ...
    JDIMAsyncReadPacket *theCurrentRead;
    NSTimer *theReadTimer;
    NSMutableData *partialReadBuffer;
    NSMutableArray *theWriteQueue;
    JDIMAsyncWritePacket *theCurrentWrite;
