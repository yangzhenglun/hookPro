...
#import "JDPAFMultipartFormData.h"

@class JDPAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface JDPAFStreamingMultipartFormData : NSObject <JDPAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    JDPAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) JDPAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
