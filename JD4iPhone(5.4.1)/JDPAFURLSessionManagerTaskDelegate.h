...
@class JDPAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface JDPAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    JDPAFURLSessionManager *_manager;
...
@property(nonatomic) __weak JDPAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
