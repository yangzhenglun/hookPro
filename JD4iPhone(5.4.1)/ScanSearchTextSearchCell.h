...
@interface ScanSearchTextSearchCell : UITableViewCell <HomePageChannelDisplayItem, HomePageChannelInteractiveItem>
{
    UIButton *_textSearchButton;
}

+ (struct CGSize)calculateSizeWithData:(id)arg1 constrainedToSize:(struct CGSize)arg2;
@property(retain, nonatomic) UIButton *textSearchButton; // @synthesize textSearchButton=_textSearchButton;
- (void).cxx_destruct;
