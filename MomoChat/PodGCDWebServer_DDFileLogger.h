...
@class NSFileHandle, NSString, PodGCDWebServer_DDLogFileInfo;

@interface PodGCDWebServer_DDFileLogger : PodGCDWebServer_DDAbstractLogger <DDLogger>
{
    id <DDLogFileManager> _logFileManager;
    PodGCDWebServer_DDLogFileInfo *_currentLogFileInfo;
