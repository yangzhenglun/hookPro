...
@interface MDBookCell : MDFavoriteCell <GMGridViewDataSource, GMGridViewActionDelegate, UIActionSheetDelegate>
{
    id <MDBookCellDelegate> _delegate;
    GMGridView *_grid;
    NSMutableArray *_bookItemList;
    UITableViewCell *_arrowCell;
}

@property(retain, nonatomic) UITableViewCell *arrowCell; // @synthesize arrowCell=_arrowCell;
@property(retain, nonatomic) NSMutableArray *bookItemList; // @synthesize bookItemList=_bookItemList;
@property(retain, nonatomic) GMGridView *grid; // @synthesize grid=_grid;
@property(nonatomic) id <MDBookCellDelegate> delegate; // @synthesize delegate=_delegate;
