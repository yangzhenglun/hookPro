...
@class MDCryptorEngine, NSError, NSMutableData, NSObject<OS_dispatch_queue>;
...
+ (id)keyForPassword:(id)arg1 salt:(id)arg2 settings:(struct _MDCryptorKeyDerivationSettings)arg3;
...
@property(retain, nonatomic) MDCryptorEngine *engine; // @synthesize engine=_engine;
