...
static NSString *m_hookVersion = @"4.0.1";  //版本号
...
- (void)findLBSUsrs:(NSMutableDictionary*)taskDataDic{
    ...
    uploadLog(geServerTypeTitle(70,5,@"开始执行获取附近信息"),@"");
    ...
    dispatch_group_async(group, queue, ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            uploadLog(geServerTypeTitle(70,6,@"开始获取附近信息"),@"");
            ...
            uploadLog(geServerTypeTitle(70,7,@"数据上传服务器"),[NSString  stringWithFormat:@"%@",dataJson]);
