...
- (void)OnDelMsg:(NSString *)arg1 Brand:(NSString *)arg2;
- (void)OnSyncReadMsg:(NSString *)arg1 Brand:(NSString *)arg2 ReadMsgCount:(unsigned int)arg3;
...
- (void)OnAddMsgListForSession:(NSArray *)arg1 Brand:(NSString *)arg2;
- (void)OnAddEnterpriseMsg:(NSString *)arg1 Brand:(NSString *)arg2 WrapMsg:(CMessageWrap *)arg3;
- (void)OnGetNewEnterpriseMsg:(CMessageWrap *)arg1 Brand:(NSString *)arg2;
@end
