...
- (void)reportUnknowFile:(const char *)arg1 accessTime:(long long)arg2 modifyTime:(long long)arg3 changeTime:(long long)arg4 fileSize:(unsigned long long)arg5;
...
- (_Bool)isFileDelete:(const char *)arg1 storeTime:(long long)arg2 curTime:(long long)arg3 accessTime:(long long)arg4 modifyTime:(long long)arg5 changeTime:(long long)arg6;
- (_Bool)isFileDelete:(const char *)arg1 matchInfo:(const struct MMBizMatchInfo *)arg2 accessTime:(long long)arg3 modifyTime:(long long)arg4 changeTime:(long long)arg5 fileSize:(unsigned long long)arg6;
