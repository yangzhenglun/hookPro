...
@interface CSettingExt : NSObject <NSCoding>
{
    ...
    _Bool m_hasCardShowRedDotBySvr;
    _Bool m_hasCardShowNewBySvr;
...
@property(retain, nonatomic) NSString *m_nsCardMsgTipWordingBySvr; // @synthesize m_nsCardMsgTipWordingBySvr;
@property(retain, nonatomic) NSString *m_nsCardMsgTipIconUrlBySvr; // @synthesize m_nsCardMsgTipIconUrlBySvr;
@property(retain, nonatomic) NSString *m_nsCardRedDotTipsIconUrlBySvr; // @synthesize m_nsCardRedDotTipsIconUrlBySvr;
@property(nonatomic) unsigned int m_uiLastClearShareCardTime; // @synthesize m_uiLastClearShareCardTime;
@property(retain, nonatomic) NSString *m_nsReddotBuffBySvr; // @synthesize m_nsReddotBuffBySvr;
@property(nonatomic) unsigned int m_uiGetCardLayoutSceneBySvr; // @synthesize m_uiGetCardLayoutSceneBySvr;
@property(retain, nonatomic) NSString *m_nsCardRedDotTipsWordingBySvr; // @synthesize m_nsCardRedDotTipsWordingBySvr;
@property(nonatomic) _Bool m_hasCardShowNewBySvr; // @synthesize m_hasCardShowNewBySvr;
@property(nonatomic) _Bool m_hasCardShowRedDotBySvr; // @synthesize m_hasCardShowRedDotBySvr;
...
- (void)setCardRedBuffBySvr:(id)arg1;
- (void)setCardGetLayOutSceneBySvr:(unsigned int)arg1;
- (void)seCardMsgTipWordingBySvr:(id)arg1;
- (void)setCardMsgTipIconUrlBySvr:(id)arg1;
- (void)setCardShowIconUrlBySvr:(id)arg1;
- (void)setCardShowWordingBySvr:(id)arg1;
- (void)setCardShowRedDotBySvr:(_Bool)arg1;
