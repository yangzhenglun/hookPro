...
- (void)dumpWithPcArray:(void **)arg1 withPcSize:(int)arg2 withReportType:(int)arg3 withBlockTime:(unsigned long long)arg4;
- (void)dumpWithReportType:(int)arg1 withBlockTime:(unsigned long long)arg2;
