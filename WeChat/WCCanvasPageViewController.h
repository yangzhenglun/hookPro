...
@class CMessageWrap, MMLoadingView, MMProgressViewEx, MMTableView, MMWebImageView, NSMutableArray, NSString, UIButton, UIImage, UIImageView, UINavigationController, UIView, WCAdvertiseInfo, WCCanvasArrowDownIcon, WCDataItem;

@interface WCCanvasPageViewController : MMUIViewController <WCCanvasComponentDelegate, WCActionSheetDelegate, SessionSelectControllerDelegate, WCCommitViewResultDelegate, UIViewControllerAnimatedTransitioning, UINavigationControllerDelegate, MMImageLoaderObserver, tableViewDelegate, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate>
{
...
- (void)notifyComponentFullyDisappearWhenExit;
