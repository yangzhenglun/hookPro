...
@class CMessageWrap, MMShareActionSheet, MMShareActionSheetSection, NSArray, NSMutableDictionary, NSString, ShareTo3rdAppSettingViewController, UIDocumentInteractionController, UIViewController, WCDataItem;
