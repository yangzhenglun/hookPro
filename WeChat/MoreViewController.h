...
- (void)showSettingView;        //显示设置
- (void)showEmoticonStoreView;  //打开表情
- (void)showShareCardView;  //打开卡包
- (void)showShareCardViewInternal;  //打开卡包
- (void)showWCCardView; //打开卡包
- (void)openWCPayView;  //打开钱包
- (void)showHtml5PayView;
- (void)showWCPayView;  //打开钱包
