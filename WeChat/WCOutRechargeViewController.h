...
@interface WCOutRechargeViewController : MMUIViewController <WCOutChargeLogicDelegate, UITableViewDataSource, UITableViewDelegate, ILinkEventExt, UIAlertViewDelegate>
{
