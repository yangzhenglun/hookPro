...
@class CMessageWrap, ImageMessageNodeView, NSArray, NSString, UIImageView, UIView, WCImageView;
...
@property(nonatomic) __weak ImageMessageNodeView *imgNodeview; // @synthesize imgNodeview=_imgNodeview;
@property(nonatomic) __weak CMessageWrap *msgWrap; // @synthesize msgWrap=_msgWrap;
...
- (id)initWithMsgWrap:(id)arg1 imageNodeView:(id)arg2 fromController:(id)arg3;
