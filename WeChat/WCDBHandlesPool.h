...
#import "WCDBSignalRetryProtocol.h"

@class NSRecursiveLock, NSString, WCDBRWLock;

@interface WCDBHandlesPool : NSObject <WCDBHandleWrapProtocol, WCDBSignalRetryProtocol>
{
    WCDBRWLock *m_handleLock;
    NSRecursiveLock *m_poolLock;
    struct map<NSThread *__weak, WCDBHandleWrap *__weak, std::__1::less<NSThread *__weak>, std::__1::allocator<std::__1::pair<NSThread *const __weak, WCDBHandleWrap *__weak>>> m_usedHandles;
    struct vector<sqlite3 *, std::__1::allocator<sqlite3 *>> m_freeHandles;
    NSString *m_dbPath;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)onHandleSignalRetry:(int)arg1 cost:(int)arg2;
