...
@property(readonly, nonatomic) _Bool m_bIsSenderFromSelf; // @synthesize m_bIsSenderFromSelf;  //是否是自己发送的消息
...
@property(retain, nonatomic) NSString *m_textForMessageLabel; // @synthesize m_textForMessageLabel;  //最后一条消息
@property(retain, nonatomic) NSString *m_textForGreenLabel; // @synthesize m_textForGreenLabel;
@property(retain, nonatomic) NSString *m_textForTimeLabel; // @synthesize m_textForTimeLabel;  //发送时间
