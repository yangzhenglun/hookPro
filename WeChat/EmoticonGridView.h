...
@interface EmoticonGridView : MMUIView <EmoticonDescMgrExt, EmoticonViewWithPreviewDelegate>
{
    ...
    long long m_column;
    long long m_row;
    long long m_belongToPageNumber;
    long long m_TotalPageNumber;
    double m_itemWidth;
    double m_itemHeight;
    double m_edgeTop;
    double m_edgeLeft;
...
@property(nonatomic) long long m_TotalPageNumber; // @synthesize m_TotalPageNumber;
@property(nonatomic) long long m_belongToPageNumber; // @synthesize m_belongToPageNumber;
