...
@class DownloadImageCDNMgr, EnterpriseSendMsgMgr, EnterpriseVoiceMsgMgr, MessagePatternCacheMgr, NSMutableDictionary, NSString, OpenDownloadCDNMgr, OpenUploadCDNMgr, OpenUploadMgr, RecordUploadCDNMgr, ThumbDownloadMgr, UploadImageCDNMgr;
