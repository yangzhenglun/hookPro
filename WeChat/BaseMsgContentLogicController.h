...
@property(retain, nonatomic) CBaseContact *m_contact; // @synthesize m_contact;  //当前聊天的用户
- (void).cxx_destruct;
...
- (id)getMyFriendContact;   //得到当前用户的信息
...
- (void)onVideoOperation;  //打开照相机
- (void)selectVideo;       //点击打开相册
- (void)onSendCaptrueImage:(id)arg1;
- (void)onOpenCameraController;  //打开照相机
- (void)onOpenMediaBrowser;    //打开媒体库
