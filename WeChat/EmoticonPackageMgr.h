...
- (_Bool)installPackageAtPath:(id)arg1 withName:(id)arg2 withPid:(id)arg3;
...
- (_Bool)addEmoticonPackageSilently:(id)arg1 name:(id)arg2 payStatus:(unsigned int)arg3 downloadStatus:(unsigned int)arg4;
...
- (void)hardcodeTusiji;
- (_Bool)addHardCode:(id)arg1 name:(id)arg2;
- (void)initLocalList;
