...
@class ALAssetsLibrary, CAGradientLayer, EmoticonBoardView, MMEmoticonView, MMGrowTextView, MMTransparentButton, NSDate, NSString, NSURL, RecordView, SelectAttachmentView, SelectAttachmentViewController, ShortVideoToolbar, UIButton, UIView, VoiceInputView;
...
- (void)onInputToolViewBarBottomChanged:(double)arg1;
- (void)onInputToolViewBarTopChanged:(double)arg1;
...
- (void)voiceVoipBtnRealClicked;  //语音聊天
- (void)onVoiceVoipButtonClicked:(id)arg1;  //语音聊天 @"1"
- (void)onExpressionButtonClicked:(id)arg1;  //弹出表情面板 @"0"  0:文字 1:表情
- (void)onSendCaptrueButtonClicked:(id)arg1;
- (void)onAttachmentModeChangeButtonClicked:(id)arg1; //点击最右边的加号 @"1"
- (void)tryShowCaptrueButton;
- (void)onInputModeChangeButtonClicked:(id)arg1;  //改变输入模式 [put onInputModeChangeButtonClicked:@"2"]  1:语音 2:文字
- (void)onWillDisappear;
@property(nonatomic) __weak NSString *text;     //输入的文字 要发送的
...
- (void)OnClearText;  //清空输入框
- (void)OnTextRecoged:(id)arg1;
- (id)GetCurrentText;      //得到当前输入框的值
