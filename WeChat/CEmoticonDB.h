...
- (void).cxx_destruct;
- (unsigned int)GetCountOfEmoticonDownload:(id)arg1;
...
- (_Bool)InsertMessageInEmoticonDownload:(id)arg1;
- (_Bool)IsInEmoticonDownloadTable:(id)arg1 n64SvrID:(long long)arg2;
