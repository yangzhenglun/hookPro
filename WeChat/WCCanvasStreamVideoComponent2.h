...
@class MMProgressViewEx, MMTimer, MMUILabel, NSString, UIButton, UILabel, UIView, WCNetworkMediaCore, WCNetworkMediaSlider;

@interface WCCanvasStreamVideoComponent2 : WCCanvasComponent <WCNetworkMediaCoreDelegate>
{
    UIView *maskView;
    UILabel *titleLabel;
    UILabel *descLabel;
    UIButton *detailBtn;
    WCNetworkMediaSlider *playSliderView;
    UIButton *clearActionBtn;
...
@property(retain, nonatomic) UIButton *clearActionBtn; // @synthesize clearActionBtn;
@property(retain, nonatomic) WCNetworkMediaSlider *playSliderView; // @synthesize playSliderView;
...
- (void)onClearActionBtnClicked;
- (void)initClearActionBtn;
- (void)initSliderView;
- (void)initMaskView;
