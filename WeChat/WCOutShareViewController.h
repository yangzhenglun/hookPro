...
@class MMUILabel, NSString, UIView, WCOutInviteFriendLogic, WeChatOutGiftCard;
...
@interface WCOutShareViewController : MMUIViewController <InviteFriendLogicDelegate, ILinkEventExt>
{
    ...
    MMUILabel *_shareContentRichTextView;
}

@property(nonatomic) _Bool needShowActionsheet; // @synthesize needShowActionsheet=_needShowActionsheet;
@property(retain, nonatomic) MMUILabel *shareContentRichTextView; // @synthesize shareContentRichTextView=_shareContentRichTextView;
