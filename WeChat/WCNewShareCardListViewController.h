...
@class MMTableView, MMUIScrollView, MMUIView, NSMutableDictionary, NSString, UIActivityIndicatorView, WCNewShareCardListLogicController, WCShareCardListLoadingHeaderView;
...
@interface WCNewShareCardListViewController : MMUIViewController <WCNewShareCardListLogicDelegate, UITableViewDelegate, UITableViewDataSource, EGORefreshTableHeaderDelegate, WCCardPackageViewControllerDelegate, WCNewCardDetailViewControllerDelegate, WCActionSheetDelegate, WCShareCardMyCardEntryViewDelegate, MMTipsViewControllerDelegate>
{
    ...
    double _lastRefreshStartOffsetY;
...
@property(nonatomic) _Bool isNoDragging; // @synthesize isNoDragging=_isNoDragging;
@property(nonatomic) double lastRefreshStartOffsetY; // @synthesize lastRefreshStartOffsetY=_lastRefreshStartOffsetY;
@property(nonatomic) _Bool isHeadRefreshing; // @synthesize isHeadRefreshing=_isHeadRefreshing;
