...
@class GKImagePicker, MMToastViewController, MMUILabel, NSArray, NSString, SingleImageBrowser, UIButton, UIImage, UIImageView, UIView, WCRedEnvelopesCdnManager, WCRedEnvelopesControlData, ZCWScrollNumView;
