...
- (_Bool)StartDownloadAppAttach:(id)arg1 IsLargeFile:(_Bool)arg2 SvrSign:(id)arg3;
- (void)StopUploadAppAttach:(id)arg1;
- (_Bool)StartUploadAppAttach:(id)arg1 IsLargeFile:(_Bool)arg2 FileMd5:(id)arg3 SvrSign:(id)arg4;
