...
- (void)onCommentPhoto:(id)arg1;  //@arg1:UIButton
- (void)onClickWithBtn;     //进入自己的朋友圈
- (void)didClickImageAtIndex:(unsigned int)arg1 withKey:(id)arg2;
- (void)editBlackList;  //设置朋友圈的权限
- (void)showContactInfo; //点击朋友的头像，进入朋友的朋友圈
