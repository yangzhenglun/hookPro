...
- (void)OnOpenUnreadMsgList;  //打开摇一摇消息
- (void)OnOpenSayHello;  //打开摇一摇打招呼的人
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;
- (void)startAnimationSplit;
- (_Bool)bIsAnimating;
- (void)waitToNextAnimation;  //等待下一个摇一摇
- (void)startAnimationMerge;  //摇一摇
- (void)resetStatus;
...
- (void)updateView;
- (void)updateShakeSayHelloView;    //更新打招呼消息
