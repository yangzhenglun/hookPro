...
{
    MassSendInfo *m_info;	// 16 = 0x10
    unsigned int m_uiEventID;	// 24 = 0x18
    unsigned int m_uiMaxSupport;	// 28 = 0x1c
    // CMMDB *m_oMMDB;	// 32 = 0x20
    // NSRecursiveLock *m_oLock;	// 40 = 0x28
    NSMutableDictionary *m_dicContacts;	// 48 = 0x30
    _Bool m_bDataNeedReload;	// 56 = 0x38
    _Bool m_bCancel;	// 57 = 0x39
    CMessageWrap *m_msgWrap;	// 64 = 0x40
    _Bool m_bFreqLimit;	// 72 = 0x48
}
