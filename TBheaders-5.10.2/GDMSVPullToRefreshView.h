...
@interface GDMSVPullToRefreshView : UIView
{
    ...
    double _originalTopInset;	// 120 = 0x78
    NSMutableArray *_titles;	// 128 = 0x80
    NSMutableArray *_subtitles;	// 136 = 0x88
    NSMutableArray *_viewForState;	// 144 = 0x90
    TBAnimationView *_animationView;	// 152 = 0x98
}
