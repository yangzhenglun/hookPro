...
{
    id <WBSDKWebViewDelegate> _delegate;	// 8 = 0x8
    UIWebView *_internalWebView;	// 16 = 0x10
    WBSDKWebViewProgressView *_progressView;	// 24 = 0x18
    WBSDKWebViewErrorView *_errorView;	// 32 = 0x20
}
