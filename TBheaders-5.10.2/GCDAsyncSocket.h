...
@interface GCDAsyncSocket : NSObject
{
    ...
    GCDAsyncReadPacket *currentRead;	// 144 = 0x90
    GCDAsyncWritePacket *currentWrite;	// 152 = 0x98
    unsigned long long socketFDBytesAvailable;	// 160 = 0xa0
    GCDAsyncSocketPreBuffer *preBuffer;	// 168 = 0xa8
    CDStruct_4210025a streamContext;	// 176 = 0xb0
    ...
    GCDAsyncSocketPreBuffer *sslPreBuffer;	// 240 = 0xf0
