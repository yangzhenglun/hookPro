...
@class NSString;
@protocol JHSNavigationProtocol;

@interface JHSNavigationAdapter : NSObject <JHSNavigationProtocol>
{
    id <JHSNavigationProtocol> _navigation;	// 8 = 0x8
}

+ (id)sharedNavigationAdapter;
@property(retain, nonatomic) id <JHSNavigationProtocol> navigation; // @synthesize navigation=_navigation;
- (void).cxx_destruct;
...
- (void)injectImplWithClass:(Class)arg1;
