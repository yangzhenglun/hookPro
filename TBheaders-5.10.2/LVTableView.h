...
@class LVTableViewDelegate, LView, NSString;
...
@interface LVTableView : UITableView <LVProtocal>
{
    ...
    LVTableViewDelegate *_tableViewDelegate;	// 40 = 0x28
}

+ (int)classDefine:(struct lv_State *)arg1;
+ (void)setDefaultStyle:(Class)arg1;
@property(retain, nonatomic) LVTableViewDelegate *tableViewDelegate; // @synthesize tableViewDelegate=_tableViewDelegate;
...
- (void)reloadData;
- (id)lv_getViewFromLuaByKey:(id)arg1;
- (void)layoutSubviews;
- (void)dealloc;
