...
@protocol WeAppCycleScrollViewDatasource, WeAppCycleScrollViewDelegate;

@interface WeAppCycleScrollView : UIView <UIScrollViewDelegate>
{
    NSTimer *_timer;	// 8 = 0x8
    UIScrollView *_scrollView;	// 16 = 0x10
    WeAppColorPageControl *_pageControl;	// 24 = 0x18
    long long _totalPages;	// 32 = 0x20
    long long _curPage;	// 40 = 0x28
    NSMutableArray *_curViews;	// 48 = 0x30
    id <WeAppCycleScrollViewDelegate> _delegate;	// 56 = 0x38
    id <WeAppCycleScrollViewDatasource> _datasource;	// 64 = 0x40
    ...
    _Bool _isPageControlHide;	// 76 = 0x4c
