...
#import "WeAppTTTAttributedLabel-Protocol.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSString, NSTextCheckingResult, UIColor;
@protocol WeAppTTTAttributedLabelDelegate;

@interface WeAppTTTAttributedLabel : UILabel <WeAppTTTAttributedLabel>
{
    ...
    id <WeAppTTTAttributedLabelDelegate> _delegate;	// 56 = 0x38
    ...
    struct CGSize _highlightedShadowOffset;	// 176 = 0xb0
    struct UIEdgeInsets _textInsets;	// 192 = 0xc0
}
