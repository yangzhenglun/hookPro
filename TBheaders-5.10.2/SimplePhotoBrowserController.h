...
@interface SimplePhotoBrowserController : UIView <UIScrollViewDelegate, UIActionSheetDelegate>
{
    ...
    UIImageView *_maskImg;	// 144 = 0x90
    UIPageControl *_pageControl;	// 152 = 0x98
    CDUnknownBlockType _changeImageBlock;	// 160 = 0xa0
    CDUnknownBlockType _simplePhotoBrowserVCDisapperBlock;	// 168 = 0xa8
    struct CGRect _maskFrame;	// 176 = 0xb0
}
