...
@interface TBRateAppendOrderRateView : UIView <UITextFieldDelegate, TBRateImageUploadProtocol, TBRateVoiceInputViewDelegate>
{
    TBRateAppendOrderRateInfoComponent *_appendRateComponent;	// 8 = 0x8
    id <TBRateImageUploadProtocol> _delegate;	// 16 = 0x10
    UIView *_splitLineView;	// 24 = 0x18
    UILabel *_appendRateLable;	// 32 = 0x20
    UITextView *_appendFeedBackTextView;	// 40 = 0x28
    TBRateImageUploadView *_imageUploadView;	// 48 = 0x30
    NSString *_feedBackplaceholder;	// 56 = 0x38
    UIView *_bottomView;	// 64 = 0x40
    TBRateEditPhotoGuidView *_editPhotoGuidView;	// 72 = 0x48
    TBRateVoiceInputView *_voiceInputView;	// 80 = 0x50
}
