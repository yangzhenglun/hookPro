...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, TFENetworkReachabilityManager, TFESecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, TFEURLResponseSerialization;
