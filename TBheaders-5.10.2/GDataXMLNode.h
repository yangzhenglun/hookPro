...
{
    struct _xmlNode *xmlNode_;	// 8 = 0x8
    _Bool shouldFreeXMLNode_;	// 16 = 0x10
    NSString *cachedName_;	// 24 = 0x18
    NSArray *cachedChildren_;	// 32 = 0x20
    NSArray *cachedAttributes_;	// 40 = 0x28
}
