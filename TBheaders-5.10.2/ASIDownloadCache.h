...
{
    int defaultCachePolicy;	// 8 = 0x8
    NSString *storagePath;	// 16 = 0x10
    NSRecursiveLock *accessLock;	// 24 = 0x18
    _Bool shouldRespectCacheControlHeaders;	// 32 = 0x20
}
...
- (void)clearCachedResponsesForStoragePolicy:(int)arg1 beforeInterval:(double)arg2;
