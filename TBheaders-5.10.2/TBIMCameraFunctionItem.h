...
@interface TBIMCameraFunctionItem : NSObject <UINavigationControllerDelegate, UIImagePickerControllerDelegate, TBImagePickerConfirmViewControllerDelegate, TBIMInputFunctionItem>
{
    _Bool _isNew;	// 8 = 0x8
