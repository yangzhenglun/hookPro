...
@interface TBRuleView : UIView <UITableViewDataSource, UITableViewDelegate>
{
    ...
    NSArray *_dataArray;	// 56 = 0x38
    NSMutableArray *_modelArray;	// 64 = 0x40
    UITableView *_mainTable;	// 72 = 0x48
