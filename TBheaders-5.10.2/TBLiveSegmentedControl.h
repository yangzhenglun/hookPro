...
{
    _Bool _showNofiDelegate;	// 8 = 0x8
    NSArray *_buttons;	// 16 = 0x10
    double _edgeMargin;	// 24 = 0x18
    double _gradientScrollOffset;	// 32 = 0x20
    double _gradientPercentage;	// 40 = 0x28
    long long _selectedIndex;	// 48 = 0x30
    id <TBLiveSegmentedControlDelegate> _delegate;	// 56 = 0x38
    UIScrollView *_scrollView;	// 64 = 0x40
    UIColor *_gradientColor;	// 72 = 0x48
    UIColor *_buttonColor;	// 80 = 0x50
    UIColor *_buttonHighlightColor;	// 88 = 0x58
    UIColor *_buttonSelectedColor;	// 96 = 0x60
    UIImage *_buttonBackgroundImage;	// 104 = 0x68
    UIImage *_buttonHighlightedBackgroundImage;	// 112 = 0x70
    UIImage *_buttonSelectedBackgroundImage;	// 120 = 0x78
    UIFont *_buttonFont;	// 128 = 0x80
    UIView *_indictorView;	// 136 = 0x88
}
