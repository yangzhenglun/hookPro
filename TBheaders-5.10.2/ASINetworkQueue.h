...
{
    id delegate;	// 24 = 0x18
    SEL requestDidStartSelector;	// 32 = 0x20
    SEL requestDidReceiveResponseHeadersSelector;	// 40 = 0x28
    SEL requestWillRedirectSelector;	// 48 = 0x30
    SEL requestDidFinishSelector;	// 56 = 0x38
    SEL requestDidFailSelector;	// 64 = 0x40
    SEL queueDidFinishSelector;	// 72 = 0x48
    id uploadProgressDelegate;	// 80 = 0x50
    unsigned long long bytesUploadedSoFar;	// 88 = 0x58
    unsigned long long totalBytesToUpload;	// 96 = 0x60
    id downloadProgressDelegate;	// 104 = 0x68
    unsigned long long bytesDownloadedSoFar;	// 112 = 0x70
    unsigned long long totalBytesToDownload;	// 120 = 0x78
    _Bool shouldCancelAllRequestsOnFailure;	// 128 = 0x80
    int requestsCount;	// 132 = 0x84
    _Bool showAccurateProgress;	// 136 = 0x88
    NSDictionary *userInfo;	// 144 = 0x90
}
