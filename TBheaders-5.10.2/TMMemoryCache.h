...
@interface TMMemoryCache : NSObject
{
    ...
    _YYLinkedMap *_lru;	// 72 = 0x48
    NSObject<OS_dispatch_queue> *_queue;	// 80 = 0x50
    _Bool _shouldRemoveAllObjectsOnMemoryWarning;	// 88 = 0x58
    _Bool _shouldRemoveAllObjectsWhenEnteringBackground;	// 89 = 0x59
    _Bool _releaseOnMainThread;	// 90 = 0x5a
    NSString *_name;	// 96 = 0x60
    unsigned long long _countLimit;	// 104 = 0x68
    unsigned long long _costLimit;	// 112 = 0x70
    double _ageLimit;	// 120 = 0x78
    double _autoTrimInterval;	// 128 = 0x80
    CDUnknownBlockType _didReceiveMemoryWarningBlock;	// 136 = 0x88
    CDUnknownBlockType _didEnterBackgroundBlock;	// 144 = 0x90
}
