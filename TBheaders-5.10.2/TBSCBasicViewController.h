...
@interface TBSCBasicViewController : TBViewController <TBSCBasicServiceDelegate, TBSCBasicViewProtocol, UITableViewDelegate>
{
    TBSCModelStatusInfo *_info;	// 16 = 0x10
    ...
    UIActivityIndicatorView *_nextPageLoadingView;	// 72 = 0x48
}
