...
@class IBActionSheetButton, IBActionSheetTitleView, NSMutableArray, NSString;
...
@interface IBActionSheet : UIView
{
    ...
    IBActionSheetTitleView *_titleView;	// 40 = 0x28
    id <IBActionSheetDelegate> _delegate;	// 48 = 0x30
    long long _buttonResponse;	// 56 = 0x38
    IBActionSheetButton *_cancelButton;	// 64 = 0x40
}
