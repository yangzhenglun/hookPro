...
@interface AppMonitorConfigExtraArray : NSObject
{
    ...
    NSMutableDictionary *_args;	// 16 = 0x10
    NSString *_sampling;	// 24 = 0x18
    NSMutableDictionary *_dic_dimensions_search;	// 32 = 0x20
    NSMutableDictionary *_dic_arg_search;	// 40 = 0x28
    NSLock *_dimensions_lock;	// 48 = 0x30
    NSLock *_arg_lock;	// 56 = 0x38
}
