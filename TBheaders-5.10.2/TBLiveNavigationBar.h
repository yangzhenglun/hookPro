...
#import "TBLiveMoreMessageHandlerDelegate-Protocol.h"

@class NSString, UIButton, UILabel;

@interface TBLiveNavigationBar : UIView <TBLiveMoreMessageHandlerDelegate>
{
...
- (void)setCenterItemTitle:(id)arg1;
- (void)setAlphaRatio:(double)arg1;
