...
#import "TBSCBasicViewProtocol-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSString, TBModelStatusHandler, TBModelStatusInfo, UIActivityIndicatorView, UIScrollViewSpeed, UITableView;

@interface TBSCBasicView : UIView <TBSCBasicServiceDelegate, TBSCBasicViewProtocol, UITableViewDelegate>
{
    ...
    UIActivityIndicatorView *_nextPageLoadingView;	// 56 = 0x38
}
