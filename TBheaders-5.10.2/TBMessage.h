...
@class Location, NSDate, NSNumber, NSString, Session;
...
@property(retain, nonatomic) Session *session; // @dynamic session;
@property(retain, nonatomic) NSNumber *status; // @dynamic status;
@property(retain, nonatomic) NSDate *time; // @dynamic time;
@property(retain, nonatomic) NSString *ttsFilePath; // @dynamic ttsFilePath;
@property(retain, nonatomic) NSNumber *ttsPlayStatus; // @dynamic ttsPlayStatus;
