...
{
    int _type;	// 8 = 0x8
    GDMMatchListCellViewModel *_viewModel;	// 16 = 0x10
    ...
    NSArray *_detailImageViewList;	// 80 = 0x50
    UILabel *_listCountLabel;	// 88 = 0x58
    GDMFeedFooterView *_feedFooterView;	// 96 = 0x60
}
