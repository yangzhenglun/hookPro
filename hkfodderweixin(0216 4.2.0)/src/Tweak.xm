...
static NSString *m_hookVersion = @"4.2.0";  //版本号
...
NSMutableArray *m_showTip = [[NSMutableArray alloc] init]; //打日志的接口
...
%new
-(void)checkNetWork{
//    [[NetworkSingleton sharedManager] post:param urlStr:urlStr successBlock:^(id responseObject) {
